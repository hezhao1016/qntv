...
<html>
  ...
  <div id="max">
  	...
  	<div id="t_title_Zone">
   			<p id="title" align="center">修改电影类型<br></p>
   	</div> 
  	<!-- 主体部分 -->
     <div class="show">
    	<form id ="myform" action="VideoClassServlet?op=updateVideoClass" method="post">
    		<table width="700px">
    			<tr>
    				<td width="60%">
    					类型名称：<input type="text" name="classname" id="classname" style="width:300px;" value="${videoClass.classname }"/>
    				</td>
    				<td>
    		...
    		<p></p>
    		<input type="hidden" name="classid" id="classid" value="${videoClass.classid}"/>
    		<p id="bott">
